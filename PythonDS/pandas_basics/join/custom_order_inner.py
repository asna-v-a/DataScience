...
df1=pd.read_csv("C:/Users/asnav/Desktop/DataScience/PythonDS/pandas_basics/files/custom_windows.csv")
df2=pd.read_csv("C:/Users/asnav/Desktop/DataScience/PythonDS/pandas_basics/files/order_windows.csv")
print(df1,'\n\n',df2)
