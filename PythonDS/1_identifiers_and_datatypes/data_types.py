...
print("Value of price:", price)  # Printing the value of price
...
name = "Asna"   # A string
print("Value of name:", name)  # Printing the value of name
...
print("Value of is_active:", is_active)  # Printing the value of is_active
...
print("Value of fruits:", fruits)  # Printing the value of fruits
...
print("Value of coordinates:", coordinates)  # Printing the value of coordinates
...
print("Value of person:", person)  # Printing the value of person
...
print("Value of unique_numbers:", unique_numbers)  # Printing the value of unique_numbers
...
print("Value of value:", value)  # Printing the value of value
print("Type of value:", type(value))  # Printing the type of value

# Example of Type Checking:
# You can use the 'type()' function to check the type of a variable.
print("Type of num:", type(num))   # <class 'int'>
